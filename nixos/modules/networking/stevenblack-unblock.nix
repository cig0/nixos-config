...
in {
  options.mySystem.systemd.services.stevenblack-unblock.enable = lib.mkEnableOption "Whether to unblock hosts added by {option}networking.stevenblack.block to /etc/hosts.";
