{
  xdg.configFile."vimrc".text = ''
    ...
    "#set backup
    "#function! BackupDir()
    "#   let l:backupdir=$HOME.'/.confeegs/backups/vim/backup/'.
    "#               \substitute(expand('%:p:h'), '^'.$HOME, 'here', '')
    ...
    "set ls=2          " Show bar at the bottom with filename and cursor position
    set title
    ...
    set autoread      " autoload changes [:e]
    set wildignore=*.swp,*.pyc
    set showmatch
    set lazyredraw
    set hlsearch      " when there is a previous search pattern, highlight all its matches
    set shortmess+=I  " disable stupid startup message

    " Clear highlighted text after a search by hitting ESC
    nnoremap \\ :noh<return>
